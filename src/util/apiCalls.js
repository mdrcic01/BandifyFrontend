...
export const getMyBand = () => {
  return fetch(
      BACKEND_APP_URL + "/band/owner/" + localStorage.getItem("userId"), {
        method: "GET",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + localStorage.getItem('token')
...
export const deleteBandById = (id) => {
  return fetch(
      `${BACKEND_APP_URL}/band/${id}/${localStorage.getItem('userId')}`, {
        method: "DELETE",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + localStorage.getItem('token')
...
export const registerUser = (fname, lname, username, password, role, date,
...
export const updateUser = (fname, lname, username, password, role, date,
    selectedCountry, selectedState,
    selectedCity, selectValue, selectAuthorityValue, qualification) => {
  return fetch(
      BACKEND_APP_URL + "/api/update-user/" + localStorage.getItem("userId"), {
        method: "POST",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + localStorage.getItem('token')
...
export const addBand = (bandName, price, selectValue, selectGenre,
...
export const saveApplication = (bandId) => {
  return fetch(
      BACKEND_APP_URL + "/application/" + bandId + "/" + localStorage.getItem(
          'userId'), {
        method: "POST",
        headers: {
          'Content-Type': 'application/json',
...
export const updateApplicationStatus = (bandId, musicianId, status) => {
  return fetch(
      BACKEND_APP_URL + "/application/" + bandId + "/" + musicianId + "/"
      + status, {
        method: "POST",
        headers: {
          'Content-Type': 'application/json',
...
export const getAllApplicationStatus = () => {
  return fetch(
      BACKEND_APP_URL + "/application/musician/" + localStorage.getItem(
          'userId'), {
        method: "GET",
        headers: {
          'Content-Type': 'application/json',
...
export const editBand = (bandName, price, selectValue, selectGenre,
    selectInstrumentValue, id) => {
  console.log(JSON.stringify({
    "bandName": bandName,
    "price": price,
    "currency": selectValue,
...
export const addMovie = (movieName, movieDesc, movieCast, movieGender,
...
export const deleteMovies = (id) => {
  return fetch(
      BACKEND_APP_URL + "/movies/" + id + "/" + localStorage.getItem("userId"),
      {
        method: "DELETE",
        headers: {
          'Content-Type': 'application/json',
...
export const editMovie = (movieId, movieName, movieDesc, movieCast, movieGender,
    movieDuration, moviePoster) => {
...
export const addTheater = (theaterName, noOfRows, noOfSeats, street, city,
    state) => {
...
export const deleteTheaters = (id) => {
  return fetch(BACKEND_APP_URL + "/theaters/" + id + "/" + localStorage.getItem(
      "userId"), {
    method: "DELETE",
    headers: {
      'Content-Type': 'application/json',
...
export const deleteshows = (id, theaterId) => {
  return fetch(
      BACKEND_APP_URL + "/shows/" + localStorage.getItem("userId") + "/"
      + theaterId + "/" + id, {
        method: "DELETE",
        headers: {
          'Content-Type': 'application/json',
...
export const deleteModerators = (id) => {
  return fetch(
      BACKEND_APP_URL + "/moderator/" + localStorage.getItem("userId") + "/"
      + id, {
        method: "DELETE",
        headers: {
          'Content-Type': 'application/json',
...
export const editTheater = (theaterId, theaterName, noOfRows, noOfSeats, street,
    city, state) => {
  console.log("editHospitals called" + JSON.stringify({
    "name": theaterName,
    "noOfRows": noOfRows,
